...
Docs: this was executed as a subagent-driven task list (R1-R9) directly following the v1.4.0 brainstorm; no separate spec/plan file — see task history in this session.
