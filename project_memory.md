...
* **Build Command**:
  ...
  ```
* **Target Output**: `build/libs/mia-aperture-mod-1.0.9.jar`
...
* **LevelRenderer Injection**: Injects at `LevelRenderer.renderLevel` (Mojang-mapped 1.21.1 naming) at `RETURN` to draw the FBO Minimap.
...
* **Last Release**: `v1.0.9` (fixes blank map rendering by targeting renderLevel RETURN to guarantee fogParameters are initialized).
